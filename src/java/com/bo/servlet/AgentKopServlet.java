 ...
 * @author suhanda
 */
public class AgentKopServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (action.equalsIgnoreCase("addagent")) {
            req.put(FieldParameter.procCode, ProcessingCode.addAgentKopBackend);
            req.put(FieldParameter.userlogin, session.getAttribute("userlogin"));
            req.put(RuleNameParameter.cu_id, request.getParameter("cu_id"));
            req.put(RuleNameParameter.no_ba, request.getParameter("no_ba"));
            req.put(RuleNameParameter.img_ktp, request.getParameter("img_ktp"));
            ...
            if (status.equals("0000")) {
                RequestDispatcher rd = getServletContext().getRequestDispatcher("/list_agent_kop.jsp");
                ...
                RequestDispatcher rd = getServletContext().getRequestDispatcher("/add_agent_kop.jsp");
                PrintWriter out = response.getWriter();
...
//            resp = mp.decryptMessage(responseWeb);
//
//            AgentKop agentyabes = new AgentKop();
//            agentyabes.setAgent_id(resp.get(RuleNameParameter.agent_id).toString());
//            agentyabes.setAgent_name(resp.get(RuleNameParameter.agent_name).toString());
//            agentyabes.setPhonenumber(resp.get(FieldParameter.phonenumber).toString());
//
