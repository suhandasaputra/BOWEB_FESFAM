                    ...
                    <div class="col-md-12">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title">Update Version Agent</h3>
                            </div>
                            <!-- /.box-header -->
                            <form class="form-horizontal" method="POST" action="VersionServlet?action=updateversionagent" name="frmAddAgentyabes" id="frmAddAgentyabes">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Version Code</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="versioncode" value="<c:out value="${vra.versioncode}" />" required/>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Version Name</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="versionname" value="<c:out value="${vra.versionname}" />" required/>
                                            </div>
                                        </div>                                        
                                    </div>
                                </div>
