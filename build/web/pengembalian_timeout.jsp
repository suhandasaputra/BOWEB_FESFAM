                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h1><b> Timeout Sukses</b></h1>
                                pengembalian Timeout ini dilakukan dengan syarat :<br> 
                                1. status di biller sukses<br>
                                2. RC di ppob 0068<br>
                                3. saldo user sudah terpotong<br>
                                <!--4. user belum mendapatkan poin-->
                                <br>
                                <br>
                                Setelah Admin melakukan proses Timeout_Sukses maka akan :<br>
                                1. RC pada menu report ppob akan berubah menjadi 0000<br>
                                <!--2. penambahan poin untuk user tersebut sesuai dengan jenis transaksi<br>-->
                                <!--3. akan ada record baru pada histori poin untuk transaksi tersebut<br>--> 
                                <br>Input Reference Number(RRN)
                                <form action="PengembalianDanaServlet?action=timeoutsukses" method="POST">
                                    <fieldset>
