...
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/MerchantServlet?action=Listmerchant",
                "dataSrc": ""
            },
            "columns": [
                {data: "merchantid",
                ...
                {data: "merchantid",
                    render: function (data) {
                        return '<form action="MerchantServlet" method="post">'
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_merchant.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daftar Merchant</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                ...
                                                <tr class="filters">
                                                    <th class="input-filter">ID Merchant</th>
                                                    <th class="input-filter">Nama Merchant</th>
                                                    <th class="input-filter">Kode Pos</th>
                                                    <th class="input-filter">Alamat</th>
