        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="update_corp.jsp">Update Koperasi</a></li>
                </ol>
            </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-success">
                            ...
                            <!-- /.box-header -->
                            <form class="form-horizontal" method="POST" action="CorporationServlet?action=updateCorp" name="frmAddAgentyabes" id="frmAddAgentyabes">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="phonenumber" readonly="" value="<c:out value="${corp.phonenumber}" />"/>
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">No Anggota</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="no_anggota" value="<c:out value="${corp.no_anggota}" />"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
