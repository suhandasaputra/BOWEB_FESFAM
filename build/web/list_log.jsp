...
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {     
                "url": "/BOWEB_FESFAM/LogServlet?action=Listlog",
                "dataSrc": ""
            },
            "columns": [
                {data: "username"},
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_log.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Log Activity</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                ...
                                                <tr class="filters">
                                                    <th class="input-filter">Userlogin</th>
                                                    <th class="input-filter">Activity</th>
