...
//            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/CorporationServlet?action=ListKop",
                "dataSrc": ""
            },
            "columns": [
                {data: "cu_id"},
                    ...
                    render: function (data) {
                        if(mySession == 'administrator'){
                            return '<form action="CorporationServlet" method="post">'
                                + '<input type="hidden" name="action" value="updateKop">'
                                + '<input type="hidden" name="cu_id" value="' + data+ '">'
                                ...
                                + '<input type="hidden" name="action" value="deleteKop">'
                                + '<input type="hidden" name="cu_id" value="' + data + '">'
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Koperasi</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
