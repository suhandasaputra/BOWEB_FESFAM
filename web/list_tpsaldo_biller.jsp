...
<script>
    $(document).ready(function () {
        $('#tabletopupbiller thead tr.filters th').each(function () {
            var title = $(this).text();
        ...
        var table = $('#tabletopupbiller').DataTable({
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/TopupbillerServlet?action=Listtopupbiller",
                "dataSrc": ""
            },
            "columns": [
                {data: "billercode"},
            ...
            "initComplete": function (settings, json) {
                ...
                $('#tabletopupbiller').fadeIn();
            },
            "footerCallback": function (tfoot, data, start, end, display) {
                var info = $('#tabletopupbiller').DataTable().page.info();
        ...
        ($("#tabletopupbiller_filter input").removeClass("input-sm"));
        ...
        $("#tabletopupbiller_wrapper thead").on("mousedown", "th", function (event) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_tpsaldo_biller.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Top Up Saldo Biller</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tabletopupbiller" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            <thead>                                            
                                                <tr>
                                                    <th>Biller Code</th>
                                                    <th>Amount</th>
