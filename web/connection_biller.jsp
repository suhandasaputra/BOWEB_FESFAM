...
<script>
    $(document).ready(function () {
        ...
        $('#tableconnection thead tr.filters th').each(function () {
            var title = $(this).text();
        ...
        var table = $('#tableconnection').DataTable({
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/ConnectionbillerServlet?action=Listconnection",
                "dataSrc": ""
            },
            "columns": [
                {data: "billername"},
                ...
                {data: "billercode",
                    render: function (data) {
                        if (mySession == 'administrator') {
                            return '<form action="ConnectionbillerServlet" method="post">'
                                    + '<input type="hidden" name="action" value="update">'
                                    + '<input type="hidden" name="billercode" value="' + data + '">'
                                    + '<button type="submit" name="submit" value="submit" class="btn btn-primary">Edit</button></form>'
                                    + '<form action="ConnectionbillerServlet" method="post">'
            ...
            "initComplete": function (settings, json) {
                ...
                $('#tableconnection').fadeIn();
            },
            "footerCallback": function (tfoot, data, start, end, display) {
                var info = $('#tableconnection').DataTable().page.info();
        ...
        ($("#tableconnection_filter input").removeClass("input-sm"));
        ...
        $("#tableconnection_wrapper thead").on("mousedown", "th", function (event) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="connection_biller.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Connection Biller</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableconnection" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            <thead>                                            
                                                <tr>
                                                    <th>Biller Name</th>
                                                    <th>Biller Code</th>
                                                ...
                                                <tr class="filters">
                                                    ...
                                                    <th class="input-filter">Biller Code</th>
                                                    <th class="input-filter">Package Name</th>
                                                    <th class="input-filter">URL Host</th>                                                                                               
                                                    <th></th>
                                                </tr>
                                            </thead>
                                        </table>
