...
<input type="text" style="width: 200px" name="' + $.trim(title).replace(/ /g, '') + '"  placeholder="Search ' + $.trim(title) + '" class="form-control daterange"/></div>');
        ...
        var table = $('#tableagent').DataTable({
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/QrServlet?action=ListQr",
                "dataSrc": ""
            },
            "columns": [
                {data: "merchantid"},
                ...
                {data: "merchantid",
                    render: function (data) {
                        if (mySession == 'administrator') {
                            return '<form action="QrServlet" method="post">'
                                    + '<input type="hidden" name="action" value="update">'
                                    + '<input type="hidden" name="merchantid" value="' + data + '">'
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daftar Warung QR</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                <tr>
                                                    ...
                                                    <th>ppob_profit</th>
                                                    <th>ref_profit</th>
                                                    <th>ppob_profit_noncorp</th>
                                                    <th>Action</th>
                                                </tr>
                                                <tr class="filters">
                                                    <th class="input-filter">merchantid</th>
                                                    <th class="input-filter">merchantname</th> 
                                                    <th class="input-filter">merchantbalance</th>
                                                    <th class="input-filter">biayaadmin</th>
                                                    <th class="input-filter">ppob_profit</th>
                                                    <th class="input-filter">ref_profit</th>
                                                    <th class="input-filter">ppob_profit_noncorp</th>
                                                    <th></th>
                                                </tr>
                                            </thead>
                                            <tfoot>
