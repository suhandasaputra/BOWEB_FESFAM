...
<script>
    $(document).ready(function () {
        ...
        $('#tablemappingagent thead tr.filters th').each(function () {
            var title = $(this).text();
        ...
        var table = $('#tablemappingagent').DataTable({
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/MappingagentServlet?action=listuserproduk",
                "dataSrc": ""
            },
            "columns": [
                {data: "trancodeid"},
                ...
                {data: "trancodeid",
                    render: function (data) {
                        if (mySession == 'administrator') {
                            return '<form action="MappingagentServlet" method="post">'
                                    + '<input type="hidden" name="action" value="update">'
                                    + '<input type="hidden" name="trancodeid" value="' + data + '">'
                                    + '<button type="submit" name="submit" value="submit" class="btn btn-primary" padding-left="19px" padding-right="19px">Edit</button></form>'
                                    + '<form action="MappingagentServlet" method="post">'
            ...
            "initComplete": function (settings, json) {
                ...
                $('#tablemappingagent').fadeIn();
            },
            "footerCallback": function (tfoot, data, start, end, display) {
                var info = $('#tablemappingagent').DataTable().page.info();
        ...
        ($("#tablemappingagent_filter input").removeClass("input-sm"));
        ...
        $("#tablemappingagent_wrapper thead").on("mousedown", "th", function (event) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_mapping_agent.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daftar Produk Untuk User</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tablemappingagent" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Kode Produk(QMA & PPOB)</th>
                                                    <th>Nama Produk</th>
                                                    <th>Harga Jual Member</th> 
                                                    <th>Harga Jual nonmember</th> 
                                                    <th>Biaya Admin</th>
                                                    <th>Biaya Admin nonmember</th>
                                                    <th>Fee PPOB Member</th>
                                                    <th>Fee PPOB Nonmember</th>
                                                    <th>Fee Leader</th>
                                                    <th>Poin</th>
                                                    <th>Poin nonmember</th>
                                                    <th>Action</th>
                                                </tr>
                                                <tr class="filters">
                                                    <th class="input-filter">Kode Produk(QMA & PPOB)</th>
                                                    <th class="input-filter">Nama Produk</th>
                                                    <th class="input-filter">Harga Jual Member</th>
                                                    <th class="input-filter">Harga Jual nonmember</th>
                                                    <th class="input-filter">Biaya Admin</th>
                                                    <th class="input-filter">Biaya Admin nonmember</th>
                                                    <th class="input-filter">Fee PPOB</th>                                                
                                                    <th class="input-filter">Fee PPOB Nonmember</th>                                                
                                                    <th class="input-filter">Fee Leader</th>                                                
                                                    <th class="input-filter">Poin</th> 
                                                    <th class="input-filter">Poin nonmember</th>    
                                                    <th></th>                                                                                               
                                                </tr>
                                            </thead>
                                        </table>
