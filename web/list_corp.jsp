...
<script>
    $(document).ready(function () {
        ...
        var table = $('#tableagent').DataTable({
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/CorporationServlet?action=ListCorp",
                "dataSrc": ""
            },
            "columns": [
                {data: "cu_id"},
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Korporasi</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                ...
                                                <tr class="filters">
                                                    <th class="input-filter">cu_id</th>
                                                    <th class="input-filter">nama_koperasi</th>                                      
                                                    <th class="input-filter">phonenumber</th>
                                                    <th class="input-filter">no_anggota</th>
                                                    <th class="input-filter">tanggal aktivasi</th>
