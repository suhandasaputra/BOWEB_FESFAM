...
<script>
    $(document).ready(function () {
        ...
        $('#tablelimit thead tr.filters th').each(function () {
            var title = $(this).text();
...
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/AgentlimitServlet?action=Listlimit",
                "dataSrc": ""
            },
            "columns": [
                {data: "agent_id"},
                ...
                {data: "agent_id",
                    render: function (data) {
                        if (mySession == 'administrator') {
                            return '<a href=AgentlimitServlet?action=update&agentId=' + data + ' class="btn btn-primary">Edit</a>';
            ...
            "footerCallback": function (tfoot, data, start, end, display) {
                var info = $('#tablelimit').DataTable().page.info();
        ...
        ($("#tablelimit_filter input").removeClass("input-sm"));
        ...
        $("#tablelimit_wrapper thead").on("mousedown", "th", function (event) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_limit.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Daftar Limit User</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tablelimit" class="table display table-bordered table-striped responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                <tr>
                                                    <th>ID User</th>
                                                    <th>Limit Nominal Harian</th>
                                                    <th>Limit Nominal Bulanan</th>
                                                    <th>Limit Transaksi Harian</th>
                                                    <th>Limit Transaksi Bulanan</th>
                                                    <th>Limit Balance</th>
                                                    <th>Aksi</th>
                                                </tr>
                                                <tr class="filters">
                                                    <th class="input-filter">ID User</th>
                                                    <th class="input-filter">Limit Nominal Harian</th>
                                                    <th class="input-filter">Limit Nominal Bulanan</th>
                                                    <th class="input-filter">Limit Transaksi Harian</th>
                                                    <th class="input-filter">Limit Balance</th>                                                
                                                    <th class="input-filter">Limit Transaksi Bulanan</th>                                                
                                                    <th></th>                                                                                               
                                                </tr>
                                            </thead>
                                            <tfoot>
