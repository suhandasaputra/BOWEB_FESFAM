...
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/HystoriPoinServlet?action=listpoinredeem",
                "dataSrc": ""
            },
            "columns": [
                {data: "redeem_itemid"},
                ...
                {data: "redeem_itemid",
                    render: function (data) {
                        if(mySession == 'administrator'){
                            return '<a href=HystoriPoinServlet?action=update&redeem_itemid=' + data + ' class="btn btn-primary">Edit</a>\n\
                        <a href=HystoriPoinServlet?action=delete&redeem_itemid=' + data + ' class="btn btn-danger">Delete</a>'
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List Poin Redeem</h3>
                                <!-- /.box-header -->
                                <div class="box-body">
                                    <div class="col-md-12">
                                        <table id="tableagent" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                            <thead>                                            
                                                ...
                                                <tr class="filters">
                                                    <th class="input-filter">Redeem Kode</th>
                                                    <th class="input-filter">Item Name</th>
                                                    <th class="input-filter">Trancode ID</th>
                                                    <th class="input-filter">Poin</th>
                                                    <th class="input-filter">Stock</th>
                                                    <th class="date-filter">Start Date</th>
                                                    <th class="date-filter">End Date</th>
                                                    <th class="input-filter">Requested</th>
                                                    <th class="input-filter">Approved</th>
                                                    <th></th>
