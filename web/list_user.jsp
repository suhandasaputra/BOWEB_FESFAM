...
<script>
    $(document).ready(function () {
        $('#tableuser thead tr.filters th').each(function () {
            var title = $(this).text();
...
//            retrieve: true,
            dom: 'Bfrtip',
            ajax: {
                url: "/BOWEB_FESFAM/LoginCRServlet?action=listuser",
                dataSrc: ""
            },
            columns: [
                {data: "userlogin"},
                ...
                {data: "userlogin",
                    render: function (data) {
                        return '<a href=LoginUDServlet?action=update&userLogin=' + data + ' class="btn btn-primary">Edit</a>\n\
                               <a href=LoginUDServlet?action=delete&userLogin=' + data + ' class="btn btn-danger">Delete</a>'
                    }
                }
            ],
            buttons: [
            ...
            "footerCallback": function (tfoot, data, start, end, display) {
                var info = $('#tableuser').DataTable().page.info();
        ...
        ($("#tableuser_filter input").removeClass("input-sm"));
        ...
        $("#tableuser_wrapper thead").on("mousedown", "th", function (event) {
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <a href="list_user.jsp" class="btn btn-default button-collection"
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">List User Login</h3>
                                <!-- /.box-header -->
                                <div
                                    <div class="box-body">
                                        <div class="col-md-12">
                                            <table id="tableuser" class="table table-bordered table-striped" cellspacing="0" width="100%">
                                                <thead>
                                                    ...
                                                    <tr class="filters">
                                                        <th class="input-filter">User Login</th>
