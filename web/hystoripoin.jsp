...
//            retrieve: true,
            dom: 'Bfrtip',
            "ajax": {
                "url": "/BOWEB_FESFAM/HystoriPoinServlet?action=listpoin",
                "dataSrc": ""
            },
            "columns": [
                {data: "agent_id"},
                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">History Poin</h3>
                                <div class="col-md-12">
                                    <table id="transaction" class="table display table-striped table-bordered responsive-utilities jambo_table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><Strong>Trx date</Strong></th>
                                                <th><Strong>Noref</Strong></th>
                                                <th><Strong>Product Code</Strong></th>
                                                <th><Strong>Poin</Strong></th>
                                                <th><Strong>Before Poin</Strong></th>
                                                <th><Strong>Current Poin</Strong></th>
                                                <th><Strong>Decsription</Strong></th>
                                            </tr>
                                            <tr class="filters">
                                                <th class="input-filter">User ID</th>
                                                <th class="date-filter">Trx date</th>
                                                <th class="input-filter">Noref</th>
                                                <th class="input-filter">Product Code Number</th>
                                                <th class="input-filter">Poin</th>
                                                <th class="input-filter">Before Poin</th>
                                                <th class="input-filter">After Poin</th>                                                
                                                <th class="input-filter">Decsription</th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
