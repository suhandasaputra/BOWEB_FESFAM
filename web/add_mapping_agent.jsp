...
//        $('#transactiontype').click(function (event) {
        var transactiontype = 'Prepaid Reload';
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box">
                            ...
                            <!-- /.box-header -->
                            <form class="form-horizontal" method="POST" action="MappingagentServlet?action=adduserprodukprepaid" name="frmAddMappingagent" id="frmAddMappingagent">
                                <div class="box-body">
                                    <div class="col-md-12">                                       
                                        ...
                                        <!--                                        <div class="form-group">
                                                                                    <label class="col-sm-2 control-label" onfocus="" title="pascabayar = Total Biaya Admin, set 0 untuk prabayar">(*)Biaya Admin</label>
                                                                                    <div class="col-sm-10">
                                        ...
                                        <br><br>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Harga Jual(Non Member)</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="number" name="hargajual_noncorp" id="hargajual_noncorp" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
