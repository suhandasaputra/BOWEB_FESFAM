                    ...
                    <div class="col-md-12">
                        <div class="box box-success">
                            <div class="box-header with-border">
                                <h3 class="box-title">Update Produk Untuk User Prepaid</h3>
                            </div>
                            <!-- /.box-header -->
                            <form class="form-horizontal" method="POST" action="MappingagentServlet?action=updateproductuser" name="frmUpdateMapping" id="frmUpdateMapping">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Harga Jual(Member)</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="number" required name="hargajual" id="hargajual" value="<c:out value="${am.hargajual}" />">
                                            </div>
                                        </div>                                        
                                        <div class="form-group">
                                        ...
                                        <br><br>
                                        <div class="form-group">
                                            <label for="Profit" class="col-sm-2 control-label">Harga Jual(Non Member)</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" type="number" required name="hargajual_noncorp" id="hargajual_noncorp" value="<c:out value="${am.hargajual_noncorp}" />">
                                            </div>
                                        </div>                                            
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                                <input class="form-control" type="hidden" required name="feejual_noncorp" id="feejual_noncorp" value="<c:out value="${am.feejual_noncorp}" />">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-10">
                                                <input class="form-control" type="hidden" required name="feejual" id="hargajual" value="<c:out value="${am.feejual}" />">
                                            </div>
                                        </div>
                                    </div>
                                </div>
