                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h3 class="box-title">Withdrawal to Bank</h3>
                            </div> 
                            <form class="form-horizontal" method="POST" action="TopupagentServlet?action=debet" name="frmAddtpAgent" id="frmAddtpAgent">
                                <div class="box-body">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="rrn" placeholder="example : 123456789012" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Norek Koperasi</label>
                                            <div class="col-sm-10">
